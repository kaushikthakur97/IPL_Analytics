...
df_1 = spark.read.format("delta").load("/FileStore/tables/bronze_layer/match_info_data/season=8/")
...
# MAGIC %md
# MAGIC 
# MAGIC ### Addition of missing match data played on {2015-04-26}
...
df_2 = spark.createDataFrame([(8, 313, 3,"Kolkata", "Eden Gardens", "Rajasthan Royals", "Kolkata Knight Riders",\
                                ...
                                "-1","-1","match_abandoned", "2015-04-26")], columns)
