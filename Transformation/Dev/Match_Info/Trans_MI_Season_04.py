...
df_1 = spark.read.format("delta").load("/FileStore/tables/bronze_layer/match_info_data/season=4/")
...
# MAGIC %md
# MAGIC 
# MAGIC ### Addition of missing match data played on {2011-04-19}
...
df_2 = spark.createDataFrame([(4, 20, 2,"Bangalore", "M Chinnaswamy Stadium", "Rajasthan Royals", "Royal Challengers Bangalore",\
                                ...
                                "-1","-1","match_abandoned", "2011-04-19")], columns)
