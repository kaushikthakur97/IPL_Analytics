...
# MAGIC %md
# MAGIC 
# MAGIC ### Read Season_05 data from bronze_layer

# COMMAND ----------

df_1 = spark.read.format("delta").load("/FileStore/tables/bronze_layer/match_info_data/season=5/")
...
# MAGIC %md
# MAGIC 
# MAGIC ### Addition of missing match data played on {2012-04-24, 2012-04-25}
...
df_2 = spark.createDataFrame([(5, 313, 2,"Kolkata", "Eden Gardens", "Deccan Chargers", "Kolkata Knight Riders",\
                                ...
                                "-1","-1","match_abandoned", "2012-04-24"),
                             (5, 333, 2,"Bangalore", "M Chinnaswamy Stadium", "Chennai Super Kings", "Royal Challengers Bangalore",\
                                "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned",\
                                "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned", "-1",\
                                "-1","-1","match_abandoned", "2012-04-25")], columns)
