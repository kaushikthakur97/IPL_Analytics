...
# MAGIC %md
# MAGIC 
# MAGIC ### Read Season_02 data from bronze_layer

# COMMAND ----------

df_1 = spark.read.format("delta").load("/FileStore/tables/bronze_layer/match_info_data/season=2/")
...
# MAGIC %md
# MAGIC 
# MAGIC ### Addition of missing match data played on {2009-04-21, 2009-04-25}
...
df_2 = spark.createDataFrame([(2, 7, 2,"Durban", "Kingsmead", "Mumbai Indians", "Rajasthan Royals",\
                                ...
                                "-1","-1","match_abandoned", "2009-04-21"), 
                             (2, 13, 2,"Cape Town", "Newlands", "Kolkata Knight Riders", "Chennai Super Kings",\
                                "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned",\
                                "match_abandoned", "match_abandoned", "match_abandoned", "match_abandoned", "-1",\
                                "-1","-1","match_abandoned", "2009-04-25")], columns)
